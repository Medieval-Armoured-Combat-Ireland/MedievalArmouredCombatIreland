...
export default function ImageTextSection(props: ImageTextSectionProps) {
    const imageOrder =
        props.imageLocation === ImageLocation.LEFT
            ? 'order-first'
            : 'order-last';
    const textOrder =
        props.imageLocation === ImageLocation.LEFT
            ...
            : 'order-first';
    return (
        <section className="grid grid-cols-2 mb-auto -papyrus-light__background" id={props.title}>
            ...
            <div className={textOrder}>
                ...
                <p
                    className="text-1xl md:text-1xl xl:text-1xl tracking-tight mb-5 -black__text"
